...
import com.argeslab.world.Node;
import com.argeslab.world.Vector2i;
import com.argeslab.world.World;

public class Entity {
	public static BufferedImage SEED_SPRITE = Game.spritesheet.getSprite(16, 16, 16, 16);
	public static BufferedImage FRUIT_SPRITE = Game.spritesheet.getSprite(0, 16, 16, 16);
	public static BufferedImage ENEMY = Game.spritesheet.getSprite(64, 16, 16, 16);
